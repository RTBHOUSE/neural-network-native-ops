...
import static com.rtbhouse.model.natives.FactorizationMachinesNativeOps.FACTOR_SIZE;
...
public class FactorizationMachinesNativeOpsTest {
    ...
    public void testSmallModel() {
        ...
        assertEquals(0.98201379003790850, FactorizationMachinesNativeOps.ffmPredict(weights, feats), 1e-07); // sigmoid(0.5 * 8)
    }
    ...
    public void testLargerModelOddNumberOfFields() {
        ...
        assertEquals(0.5192726966, FactorizationMachinesNativeOps.ffmPredict(weights, feats1), 1e-07);
        assertEquals(0.4872870062, FactorizationMachinesNativeOps.ffmPredict(weights, feats2), 1e-07);
        assertEquals(0.5098327584, FactorizationMachinesNativeOps.ffmPredict(weights, feats3), 1e-07);
    }
    ...
    public void testLargerModelEvenNumberOfFields() {
        ...
        assertEquals(0.4966875725733104, FactorizationMachinesNativeOps.ffmPredict(weights, feats1), 1e-07);
        assertEquals(0.5126955971881075, FactorizationMachinesNativeOps.ffmPredict(weights, feats2), 1e-07);
        assertEquals(0.4998221691818809, FactorizationMachinesNativeOps.ffmPredict(weights, feats3), 1e-07);
    }
